    ...
    <main className="min-h-screen flex flex-col items-center justify-start mx-auto px-6 sm:px-20 py-10" style={{ scrollBehavior: "smooth" }}>
      <div style={{ marginRight: "43%" }}>
        ...
        <div className="flex gap-4">
          ...
          <Button variant="default" style={{ marginBottom: "5%", marginTop: "22px" }} onClick={() => window.location.href = "#explore"}>Exploration Guide</Button>
          <p></p>
        </div>
      ...
      <div style={{ marginLeft: "15%" }} id="explore">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "50% 50%", gap: "30px", alignItems: "start", marginLeft: "start" }}>
          ...
          {/* ---STEP ONE---*/}
          <div>
            <h3 className="text-2xl sm:text-3xl font-bold font-source-serif-4 text-blue-700 my-5 text-left">
